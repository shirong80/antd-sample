  ...
  implements ControlValueAccessor, AfterViewInit, OnDestroy, OnInit
{
  ...
  constructor(
    ...
    @Optional()
    @Inject(NzRadioService)
    private nzRadioService: NzRadioService | null,
    @Optional()
    @Inject(NzRadioButtonDirective)
    private nzRadioButtonDirective: NzRadioButtonDirective | null
  ) {}
