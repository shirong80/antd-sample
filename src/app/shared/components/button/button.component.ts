...
@Component({
  ...
  host: {
    class: 'wise-btn',
    '[class.wise-btn-primary]': `nzType === 'primary'`,
    '[class.wise-btn-dashed]': `nzType === 'dashed'`,
    '[class.wise-btn-link]': `nzType === 'link'`,
    '[class.wise-btn-text]': `nzType === 'text'`,
    '[class.wise-btn-circle]': `nzShape === 'circle'`,
    '[class.wise-btn-round]': `nzShape === 'round'`,
    '[class.wise-btn-lg]': `nzSize === 'large'`,
    '[class.wise-btn-sm]': `nzSize === 'small'`,
    '[class.wise-btn-dangerous]': `nzDanger`,
    '[class.wise-btn-loading]': `nzLoading`,
    '[class.wise-btn-background-ghost]': `nzGhost`,
    '[class.wise-btn-block]': `nzBlock`,
    '[class.wise-input-search-button]': `nzSearch`,
    '[class.wise-btn-rtl]': `dir === 'rtl'`,
  ...
  implements OnDestroy, OnChanges, AfterViewInit, AfterContentInit, OnInit
{
  ...
  insertSpan(nodes: NodeList, renderer: Renderer2): void {
    nodes.forEach((node) => {
      // 해당 노드가 순수 텍스트일 경우, span 으로 감싼다. why?
